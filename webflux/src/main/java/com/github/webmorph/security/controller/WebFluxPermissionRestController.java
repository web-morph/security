 ...
 */
@RestController
public class WebFluxPermissionRestController {
    /**
    ...
    public Mono<HasPermissionResponse> hasPermission(@AuthenticationPrincipal Account account, @RequestBody HasPermissionRequest request) {
     ...
     */
    public record HasPermissionRequest(String permission) {
    }
