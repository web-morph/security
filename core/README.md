...
Core security package for **WebMorph** ecosystem or external Spring-based applications implemented using LuckPerms.
...
<a href="https://repo.billmarssoft.com/api/maven/latest/file/releases/com/github/webmorph/security?extension=jar" target="_blank"><img alt="Download" src="https://repo.billmarssoft.com/api/badge/latest/releases/com/github/webmorph/security"></a>
</p>
